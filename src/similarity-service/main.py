...
def get_classification(sg: float, scb: float, sw: float) -> dict:
    ...
    2. Mirip Tekstual  : SCB < 0.80 AND SW >= 0.75
    3. Mirip Semantik  : SCB >= 0.80 AND SW < 0.75
    4. Normal          : SCB < 0.80 AND SW < 0.75
    """
