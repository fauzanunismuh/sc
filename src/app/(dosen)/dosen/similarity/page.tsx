          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-sm font-semibold text-cyan-700 dark:text-cyan-100">
                ...
                Analisis Kemiripan untuk Dosen
              </div>
              <div>
                <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-white md:text-5xl">Pemantauan plagiarisme capstone</h1>
                <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-600 dark:text-slate-300 md:text-base">
                  Dosen melihat pasangan yang mencurigakan dengan skor gabungan, CodeBERT, Winnowing, dan potongan snippet yang menjelaskan bagian mana yang semantik atau tekstual.
                </p>
              </div>
            </div>
